...
int nAnonymizeLeduroAmount = 500000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Leduro
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Leduro
    // Mac: ~/Library/Application Support/Leduro
    // Unix: ~/.Leduro
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Leduro";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "leduro.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "ledurod.pid"));
